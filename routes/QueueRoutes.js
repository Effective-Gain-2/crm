...
const {transferQueueController, createQueueController, getUserQueuesController, getAllQueuesControllers, deleteQueueController, getQueueByIdController, updateQueueController, updateUserQueuesController, setQueueUsersController, toggleWebhookStatusController, updateWebhookUrlController, getUsersInQueueController } = require('../controllers/QueueController');
...
router.put('/set-queue-users', setQueueUsersController)
