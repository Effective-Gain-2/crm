...
const { getDailyCostController, getVoiceSummaryController, getVoiceTranscriptsController } = require('../controllers/VoiceViewController');
...
router.get('/get-voice-transcripts/:schema', verifyToken, allowedRoles(), getVoiceTranscriptsController);
