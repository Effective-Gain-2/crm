...
router.post('/create-receita', verifyToken, allowedRoles(), createReceitaController);
router.put('/update-receita/:receita_id/:schema', allowedRoles('tec-admin'), verifyToken, updateReceitaController);
router.delete('/delete-receita', verifyToken, allowedRoles('tec-admin'), deleteReceitaController);
